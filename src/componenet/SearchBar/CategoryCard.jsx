...
function CategoryCard({product}) {
  ...
  return (
    <div className="flex justify-around mt-4  border p-4 rounded-lg  shadow-md bg-white md:max-w-[900px] w- mx-auto">
      {/* Product Image */}
      <div className="relative min-w-[100px] min-h-[100px] ">
        ...
        <img
          src={product.images?.length > 0 ? "https://cdn.zeptonow.com/production/tr:w-210,ar-225-333,pr-true,f-auto,q-80/cms/category/474e6e58-1894-4378-86f1-168cc7266d1a.png" : "/placeholder.jpg"}
          alt={product.name}
