...
function Banner2() {
   ...
   const [list1]=useState([{image:"https://cdn.zeptonow.com/production/tr:w-210,ar-225-333,pr-true,f-auto,q-80/cms/category/474e6e58-1894-4378-86f1-168cc7266d1a.png"}
    ...
    ,{image:"https://cdn.zeptonow.com/production/tr:w-210,ar-225-333,pr-true,f-auto,q-80/cms/category/47b3a34d-8f9f-42fe-97a0-4d8350748924.png",name:"Packged Food"}]);

  const[list2]=useState(["https://cdn.zeptonow.com/production/tr:w-210,ar-225-333,pr-true,f-auto,q-80/cms/category/031c2a24-d40f-4272-8c71-8a566252495e.png",
    ...
    "https://cdn.zeptonow.com/production/tr:w-210,ar-226-334,pr-true,f-auto,q-80/cms/category/9b88fff5-73f5-46fd-999f-1622db4203d7.png"
  ]);
   const[list3]=useState(["https://cdn.zeptonow.com/production/tr:w-420,ar-486-333,pr-true,f-auto,q-80/cms/category/55a9c3a6-4960-4744-b472-0929b06e0a4a.png",
  ...
  return (
    ...
    <div className="flex flex-wrap md:ml-10  gap-6">
          {list1.map((item) => (
            <Banner2Card key={item.name}  image={item.image} />
          ))}
        </div>
    </div>
    ...
    <div className="flex flex-wrap md:ml-10 gap-6">
          {list2.map((image) => (
            <Banner2Card key={image}  image={image} />
          ))}
        </div>
    </div>
